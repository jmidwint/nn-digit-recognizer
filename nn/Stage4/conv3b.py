...
*** JKM conv3.py - added data expansion to the training set

extra copy of conv3 while I work to see if I can get it to work in the new directory
...
BATCH_SIZE = 64
NUM_EPOCHS = 10 # jkm - was this originally 10
...
def expand_data(train_data, train_labels):
...
def main(argv=None):  # pylint: disable=unused-argument
    if FLAGS.self_test:
        ...
        train_data, train_labels = expand_data(train_data, train_labels)       

        # jkm - get a new validation set size? for now use same size
